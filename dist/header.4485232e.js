...
document.addEventListener('DOMContentLoaded', function () {
  var ourStory = document.querySelector('.lnb_main .our_story');
  var support = document.querySelector('.lnb_main .support');
  var storyDetail = document.querySelector('.lnb_detail .story_detail_bg');
  var supportDetail = document.querySelector('.lnb_detail .support_detail_bg');
